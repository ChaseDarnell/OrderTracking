...
To build the final jar and optimize the OrderTracking application for production, run:
...
Then navigate to [http://localhost:9494](http://localhost:9494) in your browser.
