...
import com.apsorders.orders.domain.Order;
import com.apsorders.orders.repository.OrderRepository;
...
/**
 * REST controller for managing {@link com.apsorders.orders.domain.Order}.
 */
@RestController
@RequestMapping("/api")
@Transactional
        ...
        Optional<Order> result = orderRepository
            ...
            .map(existingOrder -> {
                ...
                if (order.getPickUpDate() != null) {
                    existingOrder.setPickUpDate(order.getPickUpDate());
                }
                if (order.getRepairDate() != null) {
                    existingOrder.setRepairDate(order.getRepairDate());
                }
                if (order.getDeliveryDate() != null) {
                    existingOrder.setDeliveryDate(order.getDeliveryDate());
                }
                if (order.getrOrderNum() != null) {
                    existingOrder.setrOrderNum(order.getrOrderNum());
                }
                if (order.getInvOrderNum() != null) {
                    existingOrder.setInvOrderNum(order.getInvOrderNum());
                }
                if (order.getStatusO() != null) {
                    existingOrder.setStatusO(order.getStatusO());
                }
